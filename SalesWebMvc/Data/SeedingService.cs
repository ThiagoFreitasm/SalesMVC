...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            //***********   Testando se existe alguma coisa na base de dados   ****************
            ...
            Department d4 = new Department (5, "Book");

            //Criando os vendedores(Objetos)
            Seller s1 = new Seller(1, "Thiago", "thiago@hotmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Joao", "joao@hotmail.com", new DateTime(1979, 4, 21), 3500.0, d2);
            Seller s3 = new Seller(3, "Gustavo", "gustavo@hotmail.com", new DateTime(1988, 4, 21), 2200.0, d1);
            Seller s4 = new Seller(4, "Marc", "marc@hotmail.com", new DateTime(1993, 4, 21), 3000.0, d4);
            Seller s5 = new Seller(5, "Pedro", "pedro@hotmail.com", new DateTime(2000, 4, 21), 4000.0, d3);
            Seller s6 = new Seller(6, "Rafael", "rafael@hotmail.com", new DateTime(1997, 4, 21), 3000.0, d2);

            //Criando o SalesRecord: registrando vendas dos vendedores
            ...
            //Para efetivar essas alteracoes
